...
// Do Not Edit This File. Edit /home/macphersons/WebSight/generate-HTML-wrappers-atts-first.php Instead.
...
function option_( $atts = '', $contents = '' )
{
	return element( 
		'option', 
		$atts, 
...
function select_( $atts = '', $contents = '' )
{
	return element( 
		'select', 
		$atts, 
